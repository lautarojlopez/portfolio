	...
	return(
		<div className="text-white w-full lg:w-72 bg-neutral-800 min-h-screen md:h-screen pb-10">
			...
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex items-baseline mt-5">
					<a href='/LautaroLopez.pdf' download="Lautaro Lopez.pdf" className="cursor-pointer hover:bg-neutral-300 transition-all ease-in-out duration-200 font-bold rounded bg-white text-neutral-800 p-3 text-xl"><i className="fas fa-file-download"></i> Descarga mi CV</a>
				</div>
			</div>
		</div>
	)
